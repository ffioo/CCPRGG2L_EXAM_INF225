...
public class Regex {
    public static void main(String[] args) {
        ...
        pattern = Pattern.compile("(?=.*\\w)(?!.[SYNsyn]).{6,}");
        ...
        pattern = Pattern.compile("^(?=.*95)[\\w-.].{15,}@gmail.com");
        ...
        // "^(?=.*95)[\\w-.].{15,}@gmail.com"
        //The domain should not contain any special characters except the minus/dash
        // and the dot.
        System.out.println(tweet);
